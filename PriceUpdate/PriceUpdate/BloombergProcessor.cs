    ...
    public class BloombergProcessor
    {
        ...
        public void RunFullPriceUpdate()
        {
            ...
            List<string> _fullFields = new List<string> {"ID_BB_Unique", "ID_ISIN", "TICKER", "ID_SEDOL1", "ID_COMMON", "LEGAL_ENTITY_IDENTIFIER", "MARKET_SECTOR_DES", "EXCH_CODE", "ID_MIC_PRIM_EXCH",
                ...
                "CF_FREE_CASH_FLOW", "EBITDA", "EBIT", "ENTERPRISE_VALUE", "PAR_AMT", "BS_PAR_VAL", "CPN", "MATURITY", "INT_ACC_PER_BOND", "DVD_EX_DT", "EQY_SH_OUT", "CFI_CODE", "CNTRY_OF_INCORPORATION"};
            try
            {
                createConnection();
        ...
        private void addNewInstrumentCheck()
        {
            SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("sp_PMInstrument_GetNew", connection);
            ...
            try
            {
                ...
                "NAME", "PX_MID", "PX_BID", "PX_ASK", "PX_LAST", "FUND_NET_ASSET_VAL", "CRNCY", "EQY_DVD_SH_12M", "DVD_CRNCY", "FUND_NET_ASSET_VAL", "REL_1M", "CNTRY_OF_INCORPORATION",
                "REL_3M", "REL_6M", "REL_1YR", "REL_MTD", "REL_QTD", "REL_YTD", "IS_EPS", "PX_TO_BOOK_RATIO", "BS_CORE_CAPITAL_LOCAL_STANDARD", "MIFID_DAILY_TRANSACTIONS",
